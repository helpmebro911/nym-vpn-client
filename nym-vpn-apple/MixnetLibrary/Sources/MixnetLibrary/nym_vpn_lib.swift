 ...
 */
public func configureLib(dataDir: String, credentialMode: Bool?, sentryMonitoring: Bool)throws   {try rustCallWithError(FfiConverterTypeVpnError_lift) {
    uniffi_nym_vpn_lib_fn_func_configurelib(
        FfiConverterString.lower(dataDir),
        FfiConverterOptionBool.lower(credentialMode),
        FfiConverterBool.lower(sentryMonitoring),$0
    )
}
}
/**
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_nym_vpn_lib_checksum_func_configurelib() != 4830) {
