...
struct Nym_Vpn_StoreAccountError {
  ...
  enum OneOf_ErrorDetail: Equatable {
    case storageError(String)
    case errorResponse(Nym_Vpn_VpnApiErrorResponse)
    case unexpectedResponse(String)

  #if !swift(>=4.1)
    static func ==(lhs: Nym_Vpn_StoreAccountError.OneOf_ErrorDetail, rhs: Nym_Vpn_StoreAccountError.OneOf_ErrorDetail) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.storageError, .storageError): return {
        guard case .storageError(let l) = lhs, case .storageError(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      ...
      case (.unexpectedResponse, .unexpectedResponse): return {
        guard case .unexpectedResponse(let l) = lhs, case .unexpectedResponse(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
struct Nym_Vpn_SyncAccountError {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    static func ==(lhs: Nym_Vpn_SyncAccountError.OneOf_ErrorDetail, rhs: Nym_Vpn_SyncAccountError.OneOf_ErrorDetail) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.noAccountStored, .noAccountStored): return {
        guard case .noAccountStored(let l) = lhs, case .noAccountStored(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.errorResponse, .errorResponse): return {
        guard case .errorResponse(let l) = lhs, case .errorResponse(let r) = rhs else { preconditionFailure() }
      ...
      case (.internal, .internal): return {
        guard case .internal(let l) = lhs, case .internal(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
struct Nym_Vpn_SyncDeviceError {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    static func ==(lhs: Nym_Vpn_SyncDeviceError.OneOf_ErrorDetail, rhs: Nym_Vpn_SyncDeviceError.OneOf_ErrorDetail) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      ...
      case (.noDeviceStored, .noDeviceStored): return {
        guard case .noDeviceStored(let l) = lhs, case .noDeviceStored(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.errorResponse, .errorResponse): return {
        guard case .errorResponse(let l) = lhs, case .errorResponse(let r) = rhs else { preconditionFailure() }
...
struct Nym_Vpn_RegisterDeviceError {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    static func ==(lhs: Nym_Vpn_RegisterDeviceError.OneOf_ErrorDetail, rhs: Nym_Vpn_RegisterDeviceError.OneOf_ErrorDetail) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
struct Nym_Vpn_ForgetAccountError {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    static func ==(lhs: Nym_Vpn_ForgetAccountError.OneOf_ErrorDetail, rhs: Nym_Vpn_ForgetAccountError.OneOf_ErrorDetail) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.registrationInProgress, .registrationInProgress): return {
        guard case .registrationInProgress(let l) = lhs, case .registrationInProgress(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.errorResponse, .errorResponse): return {
        guard case .errorResponse(let l) = lhs, case .errorResponse(let r) = rhs else { preconditionFailure() }
      ...
      case (.removeAccount, .removeAccount): return {
        guard case .removeAccount(let l) = lhs, case .removeAccount(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.removeDeviceKeys, .removeDeviceKeys): return {
        guard case .removeDeviceKeys(let l) = lhs, case .removeDeviceKeys(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.resetCredentialStore, .resetCredentialStore): return {
        guard case .resetCredentialStore(let l) = lhs, case .resetCredentialStore(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.removeAccountFiles, .removeAccountFiles): return {
        guard case .removeAccountFiles(let l) = lhs, case .removeAccountFiles(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.initDeviceKeys, .initDeviceKeys): return {
        guard case .initDeviceKeys(let l) = lhs, case .initDeviceKeys(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
struct Nym_Vpn_DeleteLogFileError {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Nym_Vpn_VpnApiErrorResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Nym_Vpn_RequestZkNymError {
  ...
  #if !swift(>=4.1)
    static func ==(lhs: Nym_Vpn_RequestZkNymError.OneOf_Outcome, rhs: Nym_Vpn_RequestZkNymError.OneOf_Outcome) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      ...
      case (.vpnApi, .vpnApi): return {
        guard case .vpnApi(let l) = lhs, case .vpnApi(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.unexpectedVpnApiResponse, .unexpectedVpnApiResponse): return {
        guard case .unexpectedVpnApiResponse(let l) = lhs, case .unexpectedVpnApiResponse(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.storage, .storage): return {
        guard case .storage(let l) = lhs, case .storage(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.internal, .internal): return {
        guard case .internal(let l) = lhs, case .internal(let r) = rhs else { preconditionFailure() }
...
struct Nym_Vpn_RequestZkNymBundle {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Nym_Vpn_GetAccountStateResponse {
  ...
  struct AccountStateSummary {
    ...
    enum MnemonicState: SwiftProtobuf.Enum {
      typealias RawValue = Int
      case unspecified // = 0
      case notStored // = 1
      case stored // = 2
    ...
    enum AccountRegistered: SwiftProtobuf.Enum {
      typealias RawValue = Int
      case unspecified // = 0
    ...
    enum DeviceState: SwiftProtobuf.Enum {
      typealias RawValue = Int
      case unspecified // = 0
    ...
    struct AccountSummary {
      ...
      enum AccountState: SwiftProtobuf.Enum {
        typealias RawValue = Int
        case unspecified // = 0
        case notRegistered // = 1
        case inactive // = 2
      ...
      enum SubscriptionState: SwiftProtobuf.Enum {
        typealias RawValue = Int
        case unspecified // = 0
        case notRegistered // = 1
        case pending // = 2
...
extension Nym_Vpn_GetAccountStateResponse.AccountStateSummary.MnemonicState: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension Nym_Vpn_GetAccountStateResponse.AccountStateSummary.AccountRegistered: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension Nym_Vpn_GetAccountStateResponse.AccountStateSummary.DeviceState: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension Nym_Vpn_GetAccountStateResponse.AccountStateSummary.AccountSummary.AccountState: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension Nym_Vpn_GetAccountStateResponse.AccountStateSummary.AccountSummary.SubscriptionState: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
struct Nym_Vpn_GetDevicesResponse {
  ...
  struct Device {
    ...
    enum DeviceStatus: SwiftProtobuf.Enum {
      typealias RawValue = Int
      case unspecified // = 0
      case active // = 1
      case inactive // = 2
...
extension Nym_Vpn_GetDevicesResponse.Device.DeviceStatus: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
struct Nym_Vpn_DeleteLogFileResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Nym_Vpn_StoreAccountError.OneOf_ErrorDetail: @unchecked Sendable {}
extension Nym_Vpn_SyncAccountError: @unchecked Sendable {}
extension Nym_Vpn_SyncAccountError.OneOf_ErrorDetail: @unchecked Sendable {}
extension Nym_Vpn_SyncDeviceError: @unchecked Sendable {}
extension Nym_Vpn_SyncDeviceError.OneOf_ErrorDetail: @unchecked Sendable {}
extension Nym_Vpn_RegisterDeviceError: @unchecked Sendable {}
extension Nym_Vpn_RegisterDeviceError.OneOf_ErrorDetail: @unchecked Sendable {}
extension Nym_Vpn_ForgetAccountError: @unchecked Sendable {}
extension Nym_Vpn_ForgetAccountError.OneOf_ErrorDetail: @unchecked Sendable {}
extension Nym_Vpn_DeleteLogFileError: @unchecked Sendable {}
extension Nym_Vpn_VpnApiErrorResponse: @unchecked Sendable {}
extension Nym_Vpn_RequestZkNymSuccess: @unchecked Sendable {}
extension Nym_Vpn_RequestZkNymError: @unchecked Sendable {}
extension Nym_Vpn_RequestZkNymError.OneOf_Outcome: @unchecked Sendable {}
extension Nym_Vpn_RequestZkNymBundle: @unchecked Sendable {}
...
extension Nym_Vpn_GetAccountStateResponse.AccountStateSummary: @unchecked Sendable {}
extension Nym_Vpn_GetAccountStateResponse.AccountStateSummary.MnemonicState: @unchecked Sendable {}
extension Nym_Vpn_GetAccountStateResponse.AccountStateSummary.AccountRegistered: @unchecked Sendable {}
extension Nym_Vpn_GetAccountStateResponse.AccountStateSummary.DeviceState: @unchecked Sendable {}
extension Nym_Vpn_GetAccountStateResponse.AccountStateSummary.AccountSummary: @unchecked Sendable {}
extension Nym_Vpn_GetAccountStateResponse.AccountStateSummary.AccountSummary.AccountState: @unchecked Sendable {}
extension Nym_Vpn_GetAccountStateResponse.AccountStateSummary.AccountSummary.SubscriptionState: @unchecked Sendable {}
extension Nym_Vpn_GetAccountStateResponse.AccountStateSummary.AccountSummary.DeviceSummary: @unchecked Sendable {}
...
extension Nym_Vpn_GetAccountUsageResponse.AccountUsages: @unchecked Sendable {}
extension Nym_Vpn_GetAccountUsageResponse.AccountUsage: @unchecked Sendable {}
...
extension Nym_Vpn_GetDevicesResponse.Device: @unchecked Sendable {}
extension Nym_Vpn_GetDevicesResponse.Device.DeviceStatus: @unchecked Sendable {}
extension Nym_Vpn_GetDevicesResponse.Devices: @unchecked Sendable {}
...
extension Nym_Vpn_GetAvailableTicketsResponse.AvailableTickets: @unchecked Sendable {}
extension Nym_Vpn_DeleteLogFileResponse: @unchecked Sendable {}
