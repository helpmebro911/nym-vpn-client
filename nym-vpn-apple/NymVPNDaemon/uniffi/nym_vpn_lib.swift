...
open class RpcClient: RpcClientProtocol, @unchecked Sendable {
    ...
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_nym_vpn_lib_fn_clone_rpcclient(self.pointer, $0) }
    }
public convenience init()async throws  {
    let pointer =
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_nym_vpn_lib_fn_constructor_rpcclient_new(
                )
            },
            pollFunc: ffi_nym_vpn_lib_rust_future_poll_pointer,
            completeFunc: ffi_nym_vpn_lib_rust_future_complete_pointer,
            freeFunc: ffi_nym_vpn_lib_rust_future_free_pointer,
    ...
    deinit {
        ...
        try! rustCall { uniffi_nym_vpn_lib_fn_free_rpcclient(pointer, $0) }
    }
...
open func disconnectTunnel()async throws   {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_nym_vpn_lib_fn_method_rpcclient_disconnect_tunnel(
...
open func getTunnelState()async throws  -> TunnelState  {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_nym_vpn_lib_fn_method_rpcclient_get_tunnel_state(
                    self.uniffiClonePointer()
                    
                )
            },
            pollFunc: ffi_nym_vpn_lib_rust_future_poll_rust_buffer,
            completeFunc: ffi_nym_vpn_lib_rust_future_complete_rust_buffer,
            freeFunc: ffi_nym_vpn_lib_rust_future_free_rust_buffer,
...
open func listenToEvents(observer: TunnelEventObserver)async throws  -> StreamObserver  {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_nym_vpn_lib_fn_method_rpcclient_listen_to_events(
                    self.uniffiClonePointer(),
...
public struct FfiConverterTypeRpcClient: FfiConverter {
    ...
    public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> RpcClient {
        return RpcClient(unsafeFromRawPointer: pointer)
    }

    public static func lower(_ value: RpcClient) -> UnsafeMutableRawPointer {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeRpcClient_lift(_ pointer: UnsafeMutableRawPointer) throws -> RpcClient {
    return try FfiConverterTypeRpcClient.lift(pointer)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeRpcClient_lower(_ value: RpcClient) -> UnsafeMutableRawPointer {
...
open class RpcError: RpcErrorProtocol, @unchecked Sendable {
    fileprivate let pointer: UnsafeMutableRawPointer!
...
#endif
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_nym_vpn_lib_fn_clone_rpcerror(self.pointer, $0) }
    }
    ...
    deinit {
        ...
        try! rustCall { uniffi_nym_vpn_lib_fn_free_rpcerror(pointer, $0) }
    }
...
open func message() -> String  {
    ...
    uniffi_nym_vpn_lib_fn_method_rpcerror_message(self.uniffiClonePointer(),$0
    )
})
}
...
extension RpcError: Swift.Error {}
...
public struct FfiConverterTypeRpcError: FfiConverter {
    ...
    public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> RpcError {
        return RpcError(unsafeFromRawPointer: pointer)
    }

    public static func lower(_ value: RpcError) -> UnsafeMutableRawPointer {
        return value.uniffiClonePointer()
    }
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeRpcError_lift(_ pointer: UnsafeMutableRawPointer) throws -> RpcError {
    return try FfiConverterTypeRpcError.lift(pointer)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeRpcError_lower(_ value: RpcError) -> UnsafeMutableRawPointer {
...
open class StreamObserver: StreamObserverProtocol, @unchecked Sendable {
...
#endif
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_nym_vpn_lib_fn_clone_streamobserver(self.pointer, $0) }
    }
    // No primary constructor declared for this class.
    ...
    deinit {
        ...
        try! rustCall { uniffi_nym_vpn_lib_fn_free_streamobserver(pointer, $0) }
    }
...
open func cancel()  {try! rustCall() {
    uniffi_nym_vpn_lib_fn_method_streamobserver_cancel(self.uniffiClonePointer(),$0
    )
}
}
...
public struct FfiConverterTypeStreamObserver: FfiConverter {
    ...
    public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> StreamObserver {
        return StreamObserver(unsafeFromRawPointer: pointer)
    }

    public static func lower(_ value: StreamObserver) -> UnsafeMutableRawPointer {
        return value.uniffiClonePointer()
    }
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeStreamObserver_lift(_ pointer: UnsafeMutableRawPointer) throws -> StreamObserver {
    return try FfiConverterTypeStreamObserver.lift(pointer)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeStreamObserver_lower(_ value: StreamObserver) -> UnsafeMutableRawPointer {
...
open class TunnelEventObserverImpl: TunnelEventObserver, @unchecked Sendable {
...
#endif
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_nym_vpn_lib_fn_clone_tunneleventobserver(self.pointer, $0) }
    }
    // No primary constructor declared for this class.
    ...
    deinit {
        ...
        try! rustCall { uniffi_nym_vpn_lib_fn_free_tunneleventobserver(pointer, $0) }
    }
...
open func onTunnelEvent(event: TunnelEvent)  {try! rustCall() {
    uniffi_nym_vpn_lib_fn_method_tunneleventobserver_on_tunnel_event(self.uniffiClonePointer(),
...
open func onClose()  {try! rustCall() {
    uniffi_nym_vpn_lib_fn_method_tunneleventobserver_on_close(self.uniffiClonePointer(),$0
    )
}
}
...
fileprivate struct UniffiCallbackInterfaceTunnelEventObserver {
    ...
    static let vtable: [UniffiVTableCallbackInterfaceTunnelEventObserver] = [UniffiVTableCallbackInterfaceTunnelEventObserver(
        ...
        uniffiFree: { (uniffiHandle: UInt64) -> () in
            let result = try? FfiConverterTypeTunnelEventObserver.handleMap.remove(handle: uniffiHandle)
            if result == nil {
...
private func uniffiCallbackInitTunnelEventObserver() {
    uniffi_nym_vpn_lib_fn_init_callback_vtable_tunneleventobserver(UniffiCallbackInterfaceTunnelEventObserver.vtable)
}
...
public struct FfiConverterTypeTunnelEventObserver: FfiConverter {
    ...
    public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> TunnelEventObserver {
        return TunnelEventObserverImpl(unsafeFromRawPointer: pointer)
    }

    public static func lower(_ value: TunnelEventObserver) -> UnsafeMutableRawPointer {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeTunnelEventObserver_lift(_ pointer: UnsafeMutableRawPointer) throws -> TunnelEventObserver {
    return try FfiConverterTypeTunnelEventObserver.lift(pointer)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeTunnelEventObserver_lower(_ value: TunnelEventObserver) -> UnsafeMutableRawPointer {
...
public struct VpnConfig {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(entryGateway: EntryPoint, exitRouter: ExitPoint, enableTwoHop: Bool, configPath: PathBuf?, credentialDataPath: PathBuf?, tunStatusListener: TunnelStatusListener?, statisticsRecipient: String?, userAgent: UserAgent) {
        self.entryGateway = entryGateway
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_nym_vpn_lib_checksum_method_rpcclient_disconnect_tunnel() != 57983) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_nym_vpn_lib_checksum_method_rpcclient_get_tunnel_state() != 4834) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_nym_vpn_lib_checksum_method_rpcclient_listen_to_events() != 11637) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_nym_vpn_lib_checksum_method_rpcerror_message() != 8681) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_nym_vpn_lib_checksum_method_streamobserver_cancel() != 47265) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_nym_vpn_lib_checksum_method_tunneleventobserver_on_tunnel_event() != 48514) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_nym_vpn_lib_checksum_method_tunneleventobserver_on_close() != 10573) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_nym_vpn_lib_checksum_method_tunnelstatuslistener_on_event() != 60728) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_nym_vpn_lib_checksum_constructor_rpcclient_new() != 11183) {
        return InitializationResult.apiChecksumMismatch
    }
