...
/// Struct holding addresses assigned by mixnet IPR upon connect.
...
/// Register client with mixnet IP router (IPR) receiving interface IP addresses upon success.
pub async fn register_with_ipr(
